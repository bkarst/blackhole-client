...
export default class Responsive extends Component {
 ...
 render() {
    console.log(this.props.nftListings)
  return (
    <div className='row'>
            ...
            <div key={index} className="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12 mb-4" style={{cursor: 'pointer'}}>
                ...
                <div className="nft__item m-0">
                    ...
                    <div className="nft__item_wrap" style={{height: `${this.state.height}px`}}>
                        <span>
                            <img onLoad={this.onImgLoad} src={nft.image_url} className="lazy nft__item_preview" alt=""/>
                        </span>
                    </div>
                    <div className="nft__item_info">
                        ...
                        <div className="nft__item_price">
                            {nft.current_bid}<span>{nft.currency}</span>
                        </div>
                        <div className="nft__item_action">
                            <span style={{color: '#F7C752'}} >Place a bid</span>
                        </div>
